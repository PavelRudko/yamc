...
namespace yamc
{
	...
	public:
		...
		void renderTerrain(const glm::mat4& projectionMatrix, const glm::mat4& viewMatrix, const std::unordered_map<uint64_t, Mesh*>& chunkMeshes, int visibleChunksRadius, const glm::vec3 cameraPosition) const;
